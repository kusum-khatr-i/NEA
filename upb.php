...
<table   >
            <tr>
                <th colspan="6"  align="center"><b> <h3><center>Bill Ispaid Detail </center></h3></b></th>
            </tr>
            <br>
            <tr>
...
if (!$con) {
  ...
  $sql = "select bid,bmon,byear,cr,pr,@uc := cr-pr AS 'uc',rate, @st := @uc*rate AS 'st',pd,@st+pd AS 'total',ipp from cusbill c where ipp=0 ";
