...
<table   >
            <tr>
                <th colspan="6"  align="center"><b> <h3><center>Customer Detail By Branch </center></h3></b></th>
            </tr>
            <br>
...
if (!$con) {
  ...
  $sql = "SELECT cid,sc,name,phonenumber,dname from customers c,detype d where c.bid=$branch_id and c.bid=d.did ";
