...
<table   >
            <tr>
                <th colspan="6"  align="center"><b> <h3><center>Bill Id Detail </center></h3></b></th>
            </tr>
            <br>
            <tr>
...
if (!$con) {
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST")
    {
        $cus_id=$_POST["cid"];
  $sql = "select bid,bmon,byear,cr,pr,@uc := cr-pr AS 'uc',rate, @st := @uc*rate AS 'st',pd,@st+pd AS 'total' from cusbill c where c.bid=$cus_id ";
  ...
  while($row=mysqli_fetch_assoc($result))
  {
    ...
    <tr>
            ...
            <td><div class='d1'><a href='pay.php'>Pay Now</a></div></td>
