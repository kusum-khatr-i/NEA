...
<table   >
            <tr>
                <th colspan="6"  align="center"><b> <h3><center>Customer payment by payment method </center></h3></b></th>
            </tr>
            <br>
            ...
            <tr>
                ...
                <th><div class='d1'><center>Payment Method</center></div></th>
...
if (!$con) {
   ...
   if($_SERVER['REQUEST_METHOD'] == "POST")
    {
        $p_id=$_POST["pid"];
        $sql ="select payid,bid,billa,dis,pen,paya,pn from paymeent p, paym m where p.pid=m.pid and p.pid =$p_id";
